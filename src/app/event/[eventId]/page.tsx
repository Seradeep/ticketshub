...
const EventDetailsPage = () => {
  ...
  const eventId = params?.eventId ? (params.eventId as string) : "0";
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="prose prose-gray max-w-none">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    ...
                    filled with entertainment, excitement, and memories that
                    will last a lifetime. Whether you&#39;re a longtime fan or
                    new to the scene, this event offers something special for
                    everyone.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    Don&#39;t miss out on this opportunity to be part of
                    something extraordinary. Book your tickets now and secure
                    your spot at one of the most anticipated events of the year!
                  </p>
                </div>
              </div>
