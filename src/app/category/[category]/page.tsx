...
const CategoryPage = () => {
  ...
  const category = params?.category ? (params.category as string) : "all";
  ...
  const catInfo =
    categoryInfo[categoryKey as keyof typeof categoryInfo] || categoryInfo.all;
    ...
    <AuthProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="pt-20">
          {/* Header */}
          <div
            className={`bg-gradient-to-r ${catInfo.gradient} text-white py-16`}
          >
