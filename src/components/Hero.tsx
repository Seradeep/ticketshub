              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {event.featured && (
                      <div
                        className="absolute top-2 sm:top-4 left-2 sm:left-4 bg-gradient-to-r from-purple-600 to-pink-600 
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6 text-white">
                      ...
                      <p className="text-xs sm:text-sm text-white/80 mb-2 sm:mb-3 hidden sm:block">
                        {event.description}
                      </p>
